...
do
    ...
    do
        ...
        do
            echo "Launching jobs for: proc. placement = ${proc_placement}, # levels of mesh refinement = ${n_refine_level}, load balancing policy = ${lb}"
            runs_root=${results_root}/uniform_refine/proc_placement_${proc_placement}/n_refine_${n_refine_level}/load_balancing_${lb}/
