...
bsub -n ${n_procs} -o ${debugging_path}/lsf_output.txt -e ${debugging_path}/lsf_error.txt ${message_race_script} ${n_procs} ${n_iters} ${msg_size} ${run_idx_low} ${run_idx_high} ${results_root}
