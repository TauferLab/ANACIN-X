...
do
    ...
    mkdir -p ${anacin_x_root}/strong_scaling_tests
    #for slice_name in $(seq 0 10); do
	#cp ${run_dir}/slices/slice_${slice_name}.graphml ${anacin_x_root}/strong_scaling_tests/slice_${slice_name}_message_race_niters_${n_iters}_nprocs_${n_procs}_msg_size_${msg_size}_run_${run_idx}.graphml
    #done
    #mkdir -p ${anacin_x_root}/weak_scaling_tests
    #cp ${run_dir}/slices/slice_2.graphml ${anacin_x_root}/weak_scaling_tests/slice2_message_race_niters_${n_iters}_nprocs_${n_procs}_msg_size_${msg_size}_run_${run_idx}.graphml
