...
if [ ${system} == "quartz" ] || [ ${system} == "catalyst" ]; then
    results_root="/p/lscratchh/chapp1/comm_patterns/unstructured_mesh_neighbor_logs/system_${system}/"
fi
...
# Visualizations
make_plot_script=${anacin_x_root}/anacin-x/event_graph_analysis/visualization/make_unstructured_mesh_example_plot.py
    ...
    do
        ...
        do
            ...
            do
                ...
                # Generate plot
                make_plot_stdout=$( sbatch -N1 --dependency=afterok:${compute_kdts_job_id} ${job_script_make_plot} ${make_plot_script} "${runs_root}/kdts.pkl" ${nd_neighbor_fraction})
